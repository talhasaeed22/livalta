...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>LivaltaCell HY40 | Livalta |  Functional, Protein-Rich Feed Ingredients</title>
      ...
      <div className="min-page w-full bg-container z-1 py-16 md:py-32 relative overflow-hidden px-4" >
        ...
        <div className="w-full">
          <div className="w-full text-center pb-16">
            <h2 className="outline small b-100 text-3xl lg:text-4xl uppercase text-blur-heading">LivaltaCell HY40</h2>
        ...
        <div className="video-react-wrapper"> 
          <Player poster="/videos/livalta-cell-hy40-video-poster-1.jpg">
            <source src="/videos/Livalta-ReEdit-v4-ENG.mp4" />
