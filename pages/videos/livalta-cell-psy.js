...
export default function Home() {
  return (
    <div>
      <Head>
        <title>
          Livalta Cell PSY Video | Livalta | Functional, Protein-Rich Feed
          Ingredients
        </title>
        <meta
          name="description"
      ...
      <div className="min-page w-full bg-container z-1 py-16 md:py-32 relative overflow-hidden px-4">
        ...
        <div className="video-react-wrapper">
          <Player poster="/videos/cat-and-dog-poster.jpg">
            <source src="/videos/livalta-cell-psy.mp4" />
